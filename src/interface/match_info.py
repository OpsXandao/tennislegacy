...
def exibir_stats_adversario(jogador, adversario, ranking):
    adversario_info = _normalizar_jogador_dict(adversario, ranking)

    print("\n--- 📊 Stats do Adversário ---")
    print(f"Nome: {adversario_info['nome']}")
    ...
    if adversario_info["pontos"] is not None:
        print(f"Pontos: {adversario_info['pontos']}")
    print(f"Overall: {adversario_info['overall']}")
    print(f"Pontos fortes: {_formatar_lista_atributos(adversario_info['atributos'])}")
    print(f"Pontos fracos: {_formatar_lista_atributos_fracos(adversario_info['atributos'])}")
    print(f"Ultimos trofeus: {_formatar_trofeus(adversario_info['trofeus'])}")


def exibir_review_partida(jogador, adversario, ranking):
    ...
    print("\n--- 🧪 Review da Partida ---")
    print(f"{jogador_info['nome']} vs {adversario_info['nome']}")
    print(f"Chance de vitoria: {jogador_info['nome']} {chance_j:.0%} | {adversario_info['nome']} {chance_a:.0%}")
    if adversario_info["posicao"]:
        print(f"Ranking adversario: #{adversario_info['posicao']}")
    print(f"Ponto forte do adversario: {_formatar_lista_atributos(adversario_info['atributos'])}")
    print(f"Ponto fraco do adversario: {_formatar_lista_atributos_fracos(adversario_info['atributos'])}")
    print(f"Ultimos trofeus do adversario: {_formatar_trofeus(adversario_info['trofeus'])}")
